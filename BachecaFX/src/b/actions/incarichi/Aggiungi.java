...
public class Aggiungi {
	...
	public static void view(Stage primaryStage) {
		...
		try {
			...
			String oggi = Utils.getCurrentStringDate();
			
			valda.setValue(LocalDate.of(Integer.valueOf(oggi.split("/")[2]),Integer.valueOf( oggi.split("/")[1]), Integer.valueOf(oggi.split("/")[0])));
